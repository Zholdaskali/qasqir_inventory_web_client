            ...
            <div>
              ...
              <div className="text-xs text-gray-600 mt-1 flex flex-wrap gap-2">
                ...
                <span className="flex items-center gap-1">
                  <FaInfoCircle
                    size={10}
                    className={shelfFreeCapacity > 0 ? "text-green-500" : "text-red-500"}
                  />
                  {shelfFreeCapacity} м³
                </span>
                <span className="flex items-center gap-1">
        ...
        {openContainers[shelf.id] && (
          <div className="mt-2 pl-6">
            {containers[shelf.id]?.length > 0 || shelf.containers?.length > 0 ? (
              ...
              <div className="text-xs text-gray-400 text-center py-1 bg-gray-50 rounded">
                Нет контейнеров
              </div>
            )}
          </div>
    ...
    <div className="mb-3 p-4 bg-white rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-all duration-200">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          >
            <HiArrowSmDown
              className={`w-6 h-6 text-gray-500 ${openShelves ? "rotate-180" : ""}`}
            />
          </button>
          <div>
            ...
            <div className="text-xs text-gray-600 mt-1 flex flex-wrap gap-2">
              ...
              <span className="flex items-center gap-1">
                <FaInfoCircle
                  size={12}
                  className={freeCapacity > 0 ? "text-green-500" : "text-red-500"}
                />
                {freeCapacity} м³
              </span>
              <span className="flex items-center gap-1">
